    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12 text-center">
                <h2 class="section-heading">RESET PASSWORD</h2><hr>
                            ...
                            <div class="col-lg-12">
                                ...
                                <form id="login-form" method="post" role="form" style="display: block;">
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" id="password" tabindex="1" class="form-control"   >
                                    </div>


                                    <div class="form-group">
                                        <div class="text-danger"> <?= form_error('password_conf') ?> </div>
                                        <label for="password">Confirm Password</label>
                                        <input type="password" name="password_conf" id="password_conf" tabindex="1" class="form-control"   >
                                    </div>
